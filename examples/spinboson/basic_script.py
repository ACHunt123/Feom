...
## Just put in arbitrary numbers for the BCF
C_ks=np.zeros((K),dtype=complex)
C_ks[0]=0.3+1.j
C_ks[1]=0.4
gam_ks=np.zeros((K),dtype=complex)
gam_ks[0]=1
gam_ks[1]=0.4
zeta=0.2
...
plt.show()
np.savetxt('output_data.out',processed_data.real,header=data_labels)
